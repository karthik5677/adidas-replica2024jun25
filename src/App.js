  ...
  return (
    ...
    <div>
          ...
          <Link className='Linksmain' to="/Home"><img className='logo' src={logo} alt='adiddaslogo'></img></Link>
            ...
            <div className='helpbox'>
              ...
              <div className='inputvalue2'>
                ...
                <Link to='/Cart' >{<p className='cartcount' >{cart.length}</p>}<img src={cartlogo} className='cartlogo' alt='adiddaslogo'n></img></Link>
        ...
        <Routes>
          ...
          <Route path="/adidas-Replica" element={<Home/>}/>
          <Route path="/adidas-replica2024" element={<Home/>}/>
